...
int get2dChar(char** array,  int row,  int col);
/*
...
void set2dChar(char** array,  int row,  int col, char value);
...
char** init2dCharArray(char** array,  int row,  int col);
...
void print2dCharArray(char** array,  int row,  int col, int offset);
 ...
 * row, col - size of printed array as if array[row][col]
 */
void free2dIntArray(int** array,  int row,  int col);
void free2dCharArray(char** array,  int row,  int col);
